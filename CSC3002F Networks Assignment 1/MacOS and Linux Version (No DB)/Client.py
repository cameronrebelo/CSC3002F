...
while locked:
    serverPassword = input("Input server password: ")
    ...
    while True:
        ...
        if command_input == 'CHAT':
            ...
            if command == "E":
                ...
                group_members = []
                print(
                    "Enter the names of the people you want in your group: ")  # going to need to ask for the IP addess
                # of members as well
